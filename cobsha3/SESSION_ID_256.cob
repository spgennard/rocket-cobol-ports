...
*>  compute the hash      
    CALL "SHA3_256" USING WS-SHA3-256-INPUT
...
*>  convert in hexa
 ...
 CALC-LEN SECTION.
    MOVE 0 TO WS-SHA3-256-INPUT-BYTE-LEN WS-LEN
    INSPECT FUNCTION REVERSE(WS-SHA3-256-INPUT) TALLYING WS-LEN FOR LEADING SPACES 
    COMPUTE WS-SHA3-256-INPUT-BYTE-LEN = LENGTH OF WS-SHA3-256-INPUT - WS-LEN
    .
