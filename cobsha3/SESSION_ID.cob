...
*>  compute the hash      
    CALL "SHA3_512" USING WS-SHA3-512-INPUT
...
*>  convert in hexa
 ...
 CALC-LEN SECTION.
    MOVE 0 TO WS-SHA3-512-INPUT-BYTE-LEN WS-LEN
    INSPECT FUNCTION REVERSE(WS-SHA3-512-INPUT) TALLYING WS-LEN FOR LEADING SPACES 
    COMPUTE WS-SHA3-512-INPUT-BYTE-LEN = LENGTH OF WS-SHA3-512-INPUT - WS-LEN
    .
