...
*>  Test case 1 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_224 test case 1:" END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_224 test case 1 passed."     END-DISPLAY
    ELSE
...
*>  Test case 2 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_224 test case 2:" END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_224 test case 2 passed."     END-DISPLAY
    ELSE
...
*>  Test case 3 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_224 test case 3:" END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_224 test case 3 passed."     END-DISPLAY
    ELSE
...
*>  Test case 4 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_224 test case 4:" END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_224 test case 4 passed."     END-DISPLAY
    ELSE
...
*>  Test case 5 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_224 test case 5:" END-DISPLAY
    ...
    CALL "SHA3_224" USING WS-STRING-1MB
                          WS-INPUT-BYTE-LEN
                          WS-SHA3-224-OUTPUT
    END-CALL
    ...
    THEN
       DISPLAY "SHA3_224 test case 5 passed."     END-DISPLAY
    ELSE
...
*>  Test case 1 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_256 test case 1:" END-DISPLAY
    DISPLAY "Input message: 'abc', the bit string (0x)616263"
            " of length 24 bits."   END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_256 test case 1 passed."     END-DISPLAY
    ELSE
...
*>  Test case 2 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_256 test case 2:" END-DISPLAY
    DISPLAY "Input message: the empty string '', the bit string of length 0."
    END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_256 test case 2 passed."     END-DISPLAY
    ELSE
...
*>  Test case 3 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_256 test case 3:" END-DISPLAY
    DISPLAY "Input message: 'abcdbcdecdefdefgefghfghighijhijkijkljklmklmn"
            "lmnomnopnopq' (length 448 bits)." END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_256 test case 3 passed."     END-DISPLAY
    ELSE
...
*>  Test case 4 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_256 test case 4:" END-DISPLAY
    DISPLAY "Input message:  'abcdefghbcdefghicdefghijdefghijkefghijklfghi"
            "jklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstno"
            "pqrstu' (length 896 bits)." END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_256 test case 4 passed."     END-DISPLAY
    ELSE
...
*>  Test case 5 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_256 test case 5:" END-DISPLAY
    DISPLAY "Input message: one million (1,000,000) repetitions of the "
            "character 'a' (0x61)." END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    CALL "SHA3_256" USING WS-STRING-1MB
                          WS-INPUT-BYTE-LEN
                          WS-SHA3-256-OUTPUT
    END-CALL
    ...
    THEN
       DISPLAY "SHA3_256 test case 5 passed."     END-DISPLAY
    ELSE
...
*>  Test case 1 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_384 test case 1:" END-DISPLAY
    DISPLAY "Input message: 'abc', the bit string (0x)616263"
            " of length 24 bits."   END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_384 test case 1 passed."     END-DISPLAY
    ELSE
...
*>  Test case 2 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_384 test case 2:" END-DISPLAY
    DISPLAY "Input message: the empty string '', the bit string of length 0."
    END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_384 test case 2 passed."     END-DISPLAY
    ELSE
...
*>  Test case 3 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_384 test case 3:" END-DISPLAY
    DISPLAY "Input message: 'abcdbcdecdefdefgefghfghighijhijkijkljklmklmn"
            "lmnomnopnopq' (length 448 bits)." END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_384 test case 3 passed."     END-DISPLAY
    ELSE
...
*>  Test case 4 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_384 test case 4:" END-DISPLAY
    DISPLAY "Input message:  'abcdefghbcdefghicdefghijdefghijkefghijklfghi"
            "jklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstno"
            "pqrstu' (length 896 bits)." END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_384 test case 4 passed."     END-DISPLAY
    ELSE
...
*>  Test case 5 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_384 test case 5:" END-DISPLAY
    DISPLAY "Input message: one million (1,000,000) repetitions of the "
            "character 'a' (0x61)." END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    CALL "SHA3_384" USING WS-STRING-1MB
                          WS-INPUT-BYTE-LEN
                          WS-SHA3-384-OUTPUT
    END-CALL
    ...
    THEN
       DISPLAY "SHA3_384 test case 5 passed."     END-DISPLAY
    ELSE
...
*>  Test case 1 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_512 test case 1:" END-DISPLAY
    DISPLAY "Input message: 'abc', the bit string (0x)616263"
            " of length 24 bits."   END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_512 test case 1 passed."     END-DISPLAY
    ELSE
...
*>  Test case 2 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_512 test case 2:" END-DISPLAY
    DISPLAY "Input message: the empty string '', the bit string of length 0."
    END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_512 test case 2 passed."     END-DISPLAY
    ELSE
...
*>  Test case 3 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_512 test case 3:" END-DISPLAY
    DISPLAY "Input message: 'abcdbcdecdefdefgefghfghighijhijkijkljklmklmn"
            "lmnomnopnopq' (length 448 bits)." END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_512 test case 3 passed."     END-DISPLAY
    ELSE
...
*>  Test case 4 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_512 test case 4:" END-DISPLAY
    DISPLAY "Input message:  'abcdefghbcdefghicdefghijdefghijkefghijklfghi"
            "jklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstno"
            "pqrstu' (length 896 bits)." END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    THEN
       DISPLAY "SHA3_512 test case 4 passed."     END-DISPLAY
    ELSE
...
*>  Test case 5 
    ...
    DISPLAY " " END-DISPLAY
    DISPLAY "-------------------------------------------" END-DISPLAY
    DISPLAY "SHA3_512 test case 5:" END-DISPLAY
    DISPLAY "Input message: one million (1,000,000) repetitions of the "
            "character 'a' (0x61)." END-DISPLAY   
    DISPLAY "Expected output:"      END-DISPLAY
    ...
    CALL "SHA3_512" USING WS-STRING-1MB
                          WS-INPUT-BYTE-LEN
                          WS-SHA3-512-OUTPUT
    END-CALL
    ...
    THEN
       DISPLAY "SHA3_512 test case 5 passed."     END-DISPLAY
    ELSE
