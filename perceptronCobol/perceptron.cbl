           ...
           PERFORM IT TIMES
              ...
              PERFORM 100 TIMES
                 READ TRAINING INTO X
                     MOVE FUNCTION NUMVAL(FEATURE1) TO FEAT1
                     MOVE FUNCTION NUMVAL(FEATURE2) TO FEAT2
                     MOVE FUNCTION NUMVAL(FEATURE3) TO FEAT3
                     MOVE FUNCTION NUMVAL(FEATURE4) TO FEAT4
